...
public class Main {
    ...
    public static void main(String... args) throws Exception {
        ClientConfig daxConfig = new ClientConfig()
                .withEndpoints("dax-dynamodb-demo.yhdqu5.clustercfg.dax.use1.cache.amazonaws.com:8111");
        AmazonDaxClient client = new ClusterDaxClient(daxConfig);

        daxDemo(client);
    }

    private static void daxDemo(AmazonDynamoDB dynamoDB) throws Exception {
